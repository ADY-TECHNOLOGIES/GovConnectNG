...
import { Flag, Mail, Phone, Eye, EyeOff, Loader2 } from 'lucide-react';
...
const Login = () => {
  ...
  const handlePhoneLogin = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      navigate(`/verify-otp?phone=${encodeURIComponent(cleanPhone)}`);
    }
  };
    ...
    >
      <Card className="w-full max-w-md border-none shadow-xl">
        ...
        <CardContent>
          ...
          <Button
            variant="outline"
            className="w-full h-12 rounded-xl border-gray-200 hover:bg-gray-50 flex items-center justify-center gap-2 font-medium"
